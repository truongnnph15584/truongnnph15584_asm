    ...
    async render(id) {
        ...
        <form id="formEdit">
            ...
            <div class="input" enctype="multipart/form-data">
                <input type="text" name="name_input" value="${data.product_name}" required id="input_name" autocomplete="off" placeholder="Name"> <br>
                <input type="text" name="price_input" value="${data.price}" required id="input_price" autocomplete="off" placeholder="Price"> <br>
                <input type="file" id="img_pr">
                <input type="text" style="visibility: hidden;" readonly value="${data.img}" id="img_pr_old">
            </div>
            ...
            <div class="sale-view">
                <input type="text" id="sale" value="${data.sale}" name="sale" required autocomplete="off" placeholder="Sale">
                <input type="text" id="view" value="${data.view}" name="view" required autocomplete="off" placeholder="View">
            </div>
            <textarea name="" id="edit_desc" cols="40" rows="12">${data.description}</textarea>
            <div class="bt">
    ...
    afterRender(id) {
        ...
        formEdit.addEventListener('submit', async function (e) {
            ...
            update_product({
                ...
                img: document.getElementById("img_pr_old").value,
