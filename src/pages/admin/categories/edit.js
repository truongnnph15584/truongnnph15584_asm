...
import { add_category, get_category, update_category } from "../../../api/categories";
const EditCategory = {
    async render(id) {
        const { data } = await get_category(id)
        ...
        <form id="formEdit">
            ...
            <div class="input" enctype="multipart/form-data">
                <input type="text" name="name_input" value="${data.cate_name}" required id="input_name" autocomplete="off" placeholder="Name"> <br>
            </div>
            <div class="bt">
